            ...
            for (int i = 0; i < modEntries.Count; i++)
            {
                ...
                if (modEntry.Gadgets.Length > 0)
                {
                    ...
                    for (int g = 0;g < gadgetCount; g++)
                    {
                        ...
                        gadgetLabel.rectTransform.offsetMin = new Vector2(10, 0);
                        gadgetLabel.rectTransform.offsetMax = new Vector2(-10, 0);
            ...
            try
            {
                ...
                if (gadgetIndex >= 0)
                {
                    ...
                    Dictionary<string, string> gadgetInfo = new Dictionary<string, string>
                    {
                        ...
                        ["Dependencies"] = mod.Attribute.Dependencies.Length > 0 ? mod.Attribute.Dependencies.Concat() : "None"
                    };
