...
namespace GadgetCore.Patches
{
    ...
    internal static class Patch_Millipede_DropLocal
    {
        ...
        public static readonly FieldInfo t = typeof(Millipede).GetField("t", BindingFlags.NonPublic | BindingFlags.Instance);
