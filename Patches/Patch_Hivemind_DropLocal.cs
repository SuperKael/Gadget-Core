...
namespace GadgetCore.Patches
{
    ...
    internal static class Patch_Hivemind_DropLocal
    {
        ...
        public static readonly FieldInfo t = typeof(Hivemind).GetField("t", BindingFlags.NonPublic | BindingFlags.Instance);
