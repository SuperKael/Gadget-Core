...
namespace GadgetCore.Patches
{
    ...
    internal static class Patch_Destroyer_DropLocal
    {
        ...
        public static readonly FieldInfo t = typeof(Destroyer).GetField("t", BindingFlags.NonPublic | BindingFlags.Instance);
