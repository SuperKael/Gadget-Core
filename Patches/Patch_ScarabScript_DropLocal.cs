...
namespace GadgetCore.Patches
{
    ...
    internal static class Patch_ScarabScript_DropLocal
    {
        ...
        public static readonly FieldInfo t = typeof(ScarabScript).GetField("t", BindingFlags.NonPublic | BindingFlags.Instance);
