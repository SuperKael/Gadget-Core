...
namespace GadgetCore.Patches
{
    ...
    static class Patch_DroidManager_UA
    {
        ...
        public static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions, ILGenerator generator)
        {
            ...
            var conditionalRef = p.FindRefByInsns(new CodeInstruction[] {
            ...
            p.InjectInsns(conditionalRef, new CodeInstruction[] {
                new CodeInstruction(OpCodes.Ldarg_1),
                new CodeInstruction(OpCodes.Ldloc_0),
                new CodeInstruction(OpCodes.Ldelem_I4)
            });
            p.InjectHook(conditionalRef, typeof(Registry<ItemRegistry, ItemInfo, ItemType>).GetMethod("HasEntry", new Type[] { typeof(int) }));
            ...
            p.InjectHook(conditionalRef, typeof(Registry<ItemRegistry, ItemInfo, ItemType>).GetMethod("GetEntry", new Type[] { typeof(int) }));
            p.InjectInsns(conditionalRef, new CodeInstruction[] {
