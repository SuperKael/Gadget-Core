...
{
    /// <summary>
    /// This is an implementation of <see cref="GadgetConfigComponent"/> that serves as a input field for representing an double-based config value.
    /// </summary>
    public class GadgetConfigDoubleComponent : GadgetConfigComponent
    {
        /// <summary>
        ...
        /// </summary>
        public readonly double? VanillaValue;
        /// <summary>
        /// Whether this component is read-only.
        /// </summary>
        public readonly bool ReadOnly;

        private readonly Action<double> ValueSetter;
